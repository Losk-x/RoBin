...
class AlexDataNode : public AlexNode<T, P> {
 public:
  ...
  static constexpr double kMaxDensity_ = 0.6;  // density after contracting,
                                               // also determines the expansion
                                               // threshold
  static constexpr double kInitDensity_ =
      0.5;  // density of data nodes after bulk loading
  static constexpr double kMinDensity_ = 0.24;  // density after expanding, also
